    ...
    >
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="rounded-xl border border-dashed border-gray-300 bg-white p-5 shadow-sm dark:border-gray-600 dark:bg-gray-800/50">
          ...
          <p className="mb-4 text-sm text-gray-700 dark:text-gray-300">
            Use the sample template to format your GT deletion file correctly.
          </p>
          <button
            type="button"
            onClick={handleSampleDownload}
            className="inline-flex w-full items-center justify-center gap-2 rounded-md border border-blue-600 bg-white px-4 py-2 text-sm font-semibold text-blue-700 transition hover:bg-blue-50 dark:border-blue-500 dark:bg-gray-800 dark:text-blue-300"
          >
            <DownloadOutlinedIcon fontSize="small" />
            Download Sample File
          </button>
        ...
        <div className="rounded-xl border border-dashed border-gray-300 bg-white p-5 shadow-sm dark:border-gray-600 dark:bg-gray-800/50">
          ...
          <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 py-8 dark:border-gray-600">
            ...
            <label className="mt-4 inline-flex cursor-pointer items-center gap-2 rounded-md border border-blue-600 bg-white px-4 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-50 dark:border-blue-500 dark:bg-gray-800 dark:text-blue-300">
      ...
      <div>
        ...
        <div className="pt-2">
          <button
            type="button"
            className="inline-flex items-center gap-2 rounded-md border border-blue-600 bg-white px-4 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-50 dark:border-blue-500 dark:bg-gray-800 dark:text-blue-300"
          >
